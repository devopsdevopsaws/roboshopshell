...
date=$(date +%F)
script_name=$0
script_path=/home/ec2-user/roboshopshell/logs
&=$script_path/$script_name-$date.log
R="\e[31m"
G="\e[32m"
N="\e[0m"
Y="\e[33m"
...
cp -rp /home/ec2-user/roboshopshell/mongo.repo /etc/yum.repos.d/mongo.repo &>>$LOGFILE
